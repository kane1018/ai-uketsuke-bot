-- Canonical replay baseline aligned to the first tracked production migration.
-- Production already had the core schema before migration history tracking began.
-- This file intentionally includes that pre-history schema so fresh local resets are reproducible.

-- =====================================================================
-- AI Chatbot Builder — replay baseline core schema
-- This tracked migration is the canonical fresh-environment bootstrap.
-- Do not execute the historical source schema.sql directly in production.
-- =====================================================================
...
-- Billing tables that also pre-dated tracked production migration history.
