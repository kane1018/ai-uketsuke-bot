  ...
  return (
    ...
    >
      ...
      <section>
        <h2>4. 第三者提供・委託</h2>
        <p className="mt-3">
          法令に基づく場合、生命・身体・財産の保護に必要な場合その他法令で認められる場合を除き、
          本人の同意なく個人データを第三者へ提供しません。
      ...
      <section>
        <h2>7. 安全管理措置</h2>
        <p className="mt-3">
          取り扱う個人データの性質とリスクに応じ、次のような安全管理措置を講じます。
        </p>
        <ul>
          <li>個人データの取扱いに関する基本方針・取扱ルールの整備</li>
          <li>取扱状況を確認できる責任体制と、漏えい等発生時の対応体制の整備</li>
          <li>個人データへアクセスできる者・権限を必要な範囲に限定するアクセス制御</li>
          <li>通信の暗号化、認証、秘密情報の分離その他の技術的安全管理</li>
          <li>利用端末・媒体の盗難、紛失、不正利用を防止するための措置</li>
          <li>委託先の選定・監督と、国外で取り扱う場合の外的環境の把握</li>
        </ul>
        <p className="mt-3">
