...
export const LEGAL_DISCLOSURE_ITEMS: readonly LegalDisclosureItem[] = [
  ...
  },
  {
    label: "無料体験",
    value:
      "新規登録者は登録から30日間、ライトプランの機能をクレジットカード登録なしで無料利用できます。無料体験終了時に自動課金は行わず、自動的に無料プランへ移行します。継続を希望する場合のみ、無料体験終了後にライトプランへ申し込みます。",
  },
  {
    label: "商品代金以外の必要料金",
    value:
  ...
  },
  {
    label: "利用上限・提供条件",
    value:
      "無料プランの月間回答数、各プランのBot数、iframe・ロゴ表示その他の機能・上限は料金ページおよび申込画面に表示します。有料プランの月間回答数は制限しません。",
  },
  {
    label: "動作環境",
    value:
  ...
  },
  {
    ...
    value:
      "受付テンプレートや本サービスの利用による成果、正確性、完全性、特定目的への適合性を保証するものではありません。公開前に利用者自身で内容を確認してください。",
  },
];
